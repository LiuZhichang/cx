...
template <>
const Vector2ui Vector2ui::Infinity(std::numeric_limits<int32_t>::infinity());
template <>
const Vector2ui Vector2ui::Left(-1, 0);
template <>
const Vector2ui Vector2ui::Right(1, 0);
template <>
const Vector2ui Vector2ui::Up(0, 1);
template <>
const Vector2ui Vector2ui::Down(0, -1);
}  // namespace cx